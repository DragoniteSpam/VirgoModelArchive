if (show_question("Flip the texture for this model horizontally?")){
    ...
    for (var i=0; i<ds_grid_height(m.vertices); i++){
        m.vertices[# 6, i]=1-m.vertices[# 6, i];
//        m.vertices[# 7, i]=1-m.vertices[# 7, i];  // this is the vertical one, leave it alone
