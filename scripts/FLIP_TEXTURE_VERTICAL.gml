if (show_question("Flip the texture for this model vertically?")){
...
//        m.vertices[# 6, i]=1-m.vertices[# 6, i];  // this is the horizontal one, leave it alone
        m.vertices[# 7, i]=1-m.vertices[# 7, i];
